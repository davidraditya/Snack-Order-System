...
<body>
	<div id='container'>
		<h2 style='font-size: 40px; text-align: center; font-family: Tahoma'>Data Pengantar</h2>
		<form action="viewa_pengantar.php" method="post">
		...
		<?php
			require("config.php");
			$query 		= sprintf("SELECT * FROM pengantar");
